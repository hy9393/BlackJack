...
var startGame = function() {
	...
	if (currentWager === 0) {
		...
		setTimeout(function(){
			// If dealer has ace for the first card and total is blackjack, game over
			if (dealerHand.length === 2 && dealerHandTotal === 21) {
				gameOver();
			}
